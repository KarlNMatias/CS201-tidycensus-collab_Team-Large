...
#Variables from table C21007: Poverty status by veteran status
vars <- c(
...
#Pull Hawai‘i data by census tract
hi_veterans_geo <- get_acs(
  geography = "tract",
  variables = vars,
  state = "15",          # 15 = Hawai‘i
  year = 2023,
...
```{r, message=FALSE, warning=FALSE, results='hide'}
oahu_veteran_poverty_map <- ggplot(hi_veterans_geo) +
  geom_sf_interactive(
    aes(
