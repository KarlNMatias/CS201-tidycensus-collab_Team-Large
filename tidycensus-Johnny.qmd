...
-   negative relationship between poverty and education

-   higher poverty tend to have fewer people with college degrees
...
2.  Take turns! Who will do what? Be careful not to overwrite one another.
    ...
    -   I will be looking for at least 6 exchanges
...
Investigating (Median Household Income) on Oahu at the census tract level.
...
oahu_income <- get_acs(
  ...
  dplyr::filter(!GEOID %in% c("15003981200","15003981900"))  # drop tiny outer tracts
```
